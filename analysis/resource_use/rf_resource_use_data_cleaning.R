...
data <- read_csv("/Volumes/ritd-ag-project-rd01pr-dmayn10/merlin/data/fia_traits/plotlvl_data_2024-06-25.csv") %>% 
	mutate(
...
data <- data %>%
	...
	as_tibble() %>%
	write_csv("traits_rf_clean.csv", file = "/Volumes/ritd-ag-project-rd01pr-dmayn10/merlin/data/fia_traits/sub/rus_rf_clean.csv")
